...
DEBUG = config("DEBUG", default=False, cast=bool)   #manuel
    
#ALLOWED_HOSTS = ['*']   #manuel

URL_CLIENTES_EXTERNOS = config('URL_CLIENTES_EXTERNOS', default='https://287116ce06d4.ngrok-free.app/api/')
...
SIMPLE_JWT = {
    "TOKEN_OBTAIN_SERIALIZER": "apps.usuario.serializer.MyTokenObtainPairSerializer",
