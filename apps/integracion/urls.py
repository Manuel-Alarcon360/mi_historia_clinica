...
from .views import TokenIntegracionListCreateView, TokenIntegracionDetailView, obtener_clientes_externos, obtener_citas, create_cliente_externo, consultar_cliente, obtener_urls_clientes
